            ...
            <div class="main container two-columns-left">
                ...
                <div class="col-left ">
                    <div class="col-left sidebar">
                        <div class="block block-account" style="text-align: left">
                            <div class="block-title">
                                <strong><span>我的账户</span></strong>
                            </div>
                            <div class="block-content">
                                <ul>
                                    <li :class="{current:active=='/mine/account'}" @click="change">
                                        <router-link to="/mine/account">帐户中心</router-link>
                                    </li>
                                    <li :class="{current:active=='/mine/editaccount'}" @click="change">
                                        <router-link to="/mine/editaccount">账户信息</router-link>
                                    </li>
                                    <li :class="{current:active=='/mine/address'||'/mine/addressAdd'}" @click="change">
                                        <router-link to="/mine/address">货运地址</router-link>
                                    </li>
                                    <li :class="{current:active=='/mine/order'}" @click="change">
                                        <router-link to="/mine/order">我的订单</router-link>
                                    </li>
                                    <li :class="{current:active=='/mine/review'}" @click="change">
                                        <router-link to="/mine/review">我的产品评论</router-link>
                                    </li>
                                    <li :class="{current:active=='/mine/favorite'}" @click="change">
                                        <router-link to="/mine/favorite">我的收藏</router-link>
                                    </li>
