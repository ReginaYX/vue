        ...
        <div class="main-container">
            <div class="main container one-column">
                <div class="account-register">
                    ...
                    <form >
                        <div class="fieldset">
                            <h2 class="legend">个人账户信息</h2>
                            <ul class="form-list">
                                <li class="fields" style="text-align: left">
                                    <div class="customer-name">
                                        <div class="field name-firstname">
                                            <label for="firstname" class="required"><em>*</em>名</label>
                                            <div class="input-box">
                                                <input id="firstname" title="First Name" maxlength="255" class="input-text required-entry" type="text" v-model="formData.firstname">
                                            </div>
                                        </div>
                                        <div class="field name-lastname">
                                            <label for="lastname" class="required"><em>*</em>姓</label>
                                            <div class="input-box">
                                                <input id="lastname" title="Last Name" maxlength="255" class="input-text required-entry" type="text" v-model="formData.lastname">
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                <li style="text-align: left">
                                    <label for="email_address" class="required"><em>*</em>邮箱地址</label>
                                    <div class="input-box">
                                        <input title="Email Address" class="input-text validate-email required-entry" type="text" id="email_address" v-model="formData.email">
                                    </div>
                                </li>
                            </ul>
                        </div>
                        <div class="fieldset" style="text-align: left">
                            ...
                            <ul class="form-list">
                                <li class="fields">
                                    <div class="field">
                                        <label for="password" class="required"><em>*</em>密码</label>
                                        <div class="input-box">
                                            <input id="password" title="Password" class="input-text required-entry validate-password" type="password" v-model="formData.password">
                                        </div>
                                    </div>
                                    <div class="field">
                                        <label for="confirmation" class="required"><em>*</em>确认密码</label>
                                        <div class="input-box">
                                            <input title="Confirm Password" id="confirmation" class="input-text required-entry validate-cpassword" type="password">
                                        </div>
                                    </div>
                                </li>
                            </ul>
                        </div>
                        <input class="thiscsrf" type="hidden" name="_csrf"><div class="buttons-set">
                        <button type="button" id="js_registBtn" class="redBtn"  @click="register" onclick="return false">
                            <em><span><i></i>提交</span></em>
                        </button>
                        <p class="back-link"><a class="back-link"><small>« </small>返回</a></p>
