        ...
        <div class="main-container">
            <div class="main container one-column">
                <div class="account-login">
                    ...
                    <form >
                        <div class="col2-set" id="form">
                            <div class="col-1 new-users">
                                <div class="content" style="text-align: left">
                                    <h2>新用户</h2>
                                    <p>在我们的店铺里面注册账户，您可以快速的下单，保存您的货运地址，查看或追踪您的订单信息，等等</p>
                                </div>
                                <button type="button" title="Create an Account" class="redBtn" onclick="return false" @click="register">
                                    <em><span><i></i>注册</span></em>
                                </button>
                            </div>
                            <div class="col-2 registered-users">
                                <div class="content" style="text-align: left">
                                    <h2>已注册用户</h2>
                                    <p>如果您已经注册了一个用户，请直接登录</p>
                                    <ul class="form-list">
                                        <li>
                                            <label for="email" class="required"><em>*</em>邮箱地址</label>
                                            <div class="input-box">
                                                <input name="email" value="" id="email" class="input-text required-entry validate-email" title="Email Address" type="text" v-model="formData.email">
                                            </div>
                                        </li>
                                        <li>
                                            <label for="pass" class="required"><em>*</em>密码</label>
                                            <div class="input-box">
                                                <input name="password" class="input-text required-entry validate-password" id="pass" title="Password" type="password" v-model="formData.password">
                                            </div>
                                        </li>

                                        <div class="clear"></div>
                                        <div class="buttons-set">
                                            <button class="redBtn" type="submit" @click="submit" onclick="return false" style="display: inline-block">
                                                <em><span><i></i>登录</span></em>
                                            </button>
                                            <a href="#" class="f-left" style="display: inline-block">忘记密码？</a>
                        ...
                        <!--<input class="thiscsrf" type="hidden" value="" name="_csrf">-->
                        <!--<div class="col2-set">-->
                            <!--<div class="col-1 new-users">-->
                                <!--<div class="buttons-set">-->
