        ...
        <div class="std">
            <div style="margin:4px 0 0">
                ...
                <div class="welcome-msg" style="text-align: left">
                    <p class="hello"><strong>你好,  !</strong></p>
                    <p>您可以在我的帐户信息中心查看最近帐户活动的快照，并更新您的帐户信息。 选择以下链接可查看或编辑信息。</p>
                </div>
                <div class="box-account box-info" style="text-align: left">
                    <div class="col2-set">
                        <div class="col-1">
                            <div class="box">
                                <div class="box-title">
                                    <h3>联系信息</h3>
                                    <router-link to="/mine/editaccount">编辑</router-link>
                                </div>
                                <div class="box-content">
                                    <div v-if="info">
                                        <span style="margin:0 10px;">{{info.email}}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col2-set">
                            <div class="col-1">
                                <div class="box">
                                    ...
                                    <div class="box-content">
                                        <p>您可以编辑您的货运地址. </p>
                                        <router-link to="/mine/address">编辑货运地址</router-link>
                                    </div>
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="box">
                                    ...
                                    <div class="box-content">
                                        <p>您可以查看您的订单信息. </p>
                                        <router-link to="/mine/order">查看</router-link>
                                    </div>
                                </div>
                            </div>
                        </div>
