        ...
        <div class="std">
            <div style="margin:4px 0 0">
                ...
                <table class="addressbook" width="100%" cellspacing="0" cellpadding="0" border="0">
                    <thead>
                    <tr class="ress_tit">
                        <th width="76" valign="middle" align="center" height="31">名</th>
                        <th width="72" valign="middle" align="center" height="31">姓</th>
                        <th width="167" valign="middle" align="center">邮箱地址</th>
                        <th width="67" valign="middle" align="center">国家</th>
                        <th width="79" valign="middle" align="center">省</th>

                        <th width="81" valign="middle" align="center"> 邮政编码 </th>
                        <th width="101" valign="middle" align="center">电话 </th>
                        <th class="th3" width="71" valign="middle" align="center">操作</th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr class="" v-for="item in info">
                        <td valign="top" align="center">{{item.first_name}}</td>
                        <td valign="top" align="center">{{item.last_name}}</td>
                        <td valign="top" align="center">{{item.email}}</td>
                        <td valign="top" align="center">{{item.countryName}}</td>
                        <td valign="top" align="center">{{item.state}}</td>
                        <td valign="top" align="center">{{item.zip}}</td>
                        <td valign="top" align="center">{{item.telephone}}</td>
                        <td class="ltp" valign="top ltp" align="center">
                            <input onclick="javascript:window.location.href='http://fecshop.appfront.fancyecommerce.com/cn/customer/address/edit?address_id=250'" class="cpointer" value="修改" name="" type="button">
                            <a href="javascript:deleteAddress(250)">删除</a>
                            <span style=" color:#cc0000">默认</span>
                ...
                <div class="product-Reviews">
                    <router-link to="/mine/addressAdd">
                        <input class="submitbutton addnew cpointer" value="增加新地址" type="button">
                    </router-link>
                </div>
            </div>
        </div>
...
export default {
  ...
  mounted  () {
    fetch('/customer/address/index', {
      ...
      .then(data => {
        if (data.code == '200') {
          this.info = data.data.addressList
        } else {
          alert(data.message)
        }
      })
