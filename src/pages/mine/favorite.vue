        ...
        <div class="std">
            <div style="margin:4px 0 0">
                ...
                <div style="width:100%;min-height:500px;">
                    <div style="width:100%;" v-if="info">
                        <ul id="review_description" style="padding:0px;text-align: left" v-if="info.name">
                            <li style="width:100%;min-height:160px;" v-for="item in info">
                                <div class="review_description_left">
                                    <router-link :to="'/detail/'+item._id.$oid">
                                        <p style="text-align:center;"><img :src="item.imgUrl" width="100px" height="133"></p>
                                    </router-link>
                                </div>
                                <div class="review_description_right" style="width:600px;">
                                    ...
                                    <div class="review_description_centen">
                                        <div class="category_product" style="display:inline-block;float:left;">
                                            <div class="c_price">
                                                <div class="price sp" v-if="info.price_info">
                                                    {{item.price_info.price.symbol}} {{item.price_info.price.value}}
                                                </div>
                                                <div class="special_price" v-if="info.price_info">
                                        ...
                                        <div class="favorite-Operation" style="display:inline-block;float:right; margin-top: 0px;">
                                            <a href="javascript:void(0)" @click="del(item.favorite_id)">
                                                删除
                                            </a>
                                        </div>
                                        <div class="clear"></div>
                                        <div style="font-weight:100">
                                            收藏时间：{{item.updated_at}}
                                        </div>
                                    </div>
                                </b></div><b>
                            </b></li><b>
...
export default {
  ...
  mounted  () {
    fetch('/customer/productfavorite/index', {
      ...
      .then(data => {
        if (data.code == '200') {
          this.info = data.data.productList
