...
.top_account .mycoount {
  background: rgba(0, 0, 0, 0) url("http://appfront.fecshoptest.com/assets/f166cd63/images/toptip.png") no-repeat scroll left top;
...
.mywish .mywishbg {
  background: rgba(0, 0, 0, 0) url("http://appfront.fecshoptest.com/assets/f166cd63/images/toptip.png") no-repeat scroll -24px 0;
  height: 25px;
  margin-top: 10px;
  width: 31px;
  display:block;
...
.mycart .mycartbg {
  background: rgba(0, 0, 0, 0) url("http://appfront.fecshoptest.com/assets/f166cd63/images/toptip.png") no-repeat scroll -55px 0;
  height: 25px;
  margin-top: 10px;
  width: 25px;
  display:block;
...
.topSeachForm .seachBtn {
  background: rgba(0, 0, 0, 0) url("http://appfront.fecshoptest.com/assets/f166cd63/images/toptip.png") no-repeat scroll -80px 0;
  border: medium none;
  cursor: pointer;
  display: inline;
  float: right;
...
.myFavorite_nohove i{
  background: rgba(0, 0, 0, 0) url("http://appfront.fecshoptest.com/assets/f166cd63/images/tag.png") no-repeat scroll -120px -48px;
...
.review_star_5 {
  background: rgba(0, 0, 0, 0) url("http://appfront.fecshoptest.com/assets/f166cd63/images/Star_5.png") no-repeat scroll 0 0;
}
.review_star_4 {
  background: rgba(0, 0, 0, 0) url("http://appfront.fecshoptest.com/assets/f166cd63/images/Star_4.png") no-repeat scroll 0 0;
}
.review_star_3 {
  background: rgba(0, 0, 0, 0) url("http://appfront.fecshoptest.com/assets/f166cd63/images/Star_3.png") no-repeat scroll 0 0;
}
.review_star_2 {
  background: rgba(0, 0, 0, 0) url("http://appfront.fecshoptest.com/assets/f166cd63/images/Star_2.png") no-repeat scroll 0 0;
}
.review_star_1 {
  background: rgba(0, 0, 0, 0) url("http://appfront.fecshoptest.com/assets/f166cd63/images/Star_1.png") no-repeat scroll 0 0;
}
.review_star_0 {
  background: rgba(0, 0, 0, 0) url("http://appfront.fecshoptest.com/assets/f166cd63/images/Star_0.png") no-repeat scroll 0 0;
}
.review_star {
  display: block;
  height: 15px;
...
a.pre_images {
  background: rgba(0, 0, 0, 0) url("http://appfront.fecshoptest.com/assets/f166cd63/images/tag.png") no-repeat scroll -104px -80px;
  border-radius: 0;
  display: block;
  height: 10px;
...
a.next_images {
  background: rgba(0, 0, 0, 0) url("http://appfront.fecshoptest.com/assets/f166cd63/images/tag.png") no-repeat scroll -104px -95px;
  display: block;
  height: 10px;
  margin: 8px 0 0 40px;
  width: 23px;
...
.btn-remove2 {
  background: rgba(0, 0, 0, 0) url("http://fecshop.appfront.fancyecommerce.com/cn/assets/5c1db8f5/images/btn_trash.gif") no-repeat scroll 0 0;
  display: block;
  font-size: 0;
  height: 16px;
  line-height: 0;
